...
const form = useForm({
    nombre:props.departamentos.nombre
});
...
<template>
    <AppLayout title="Editar Departamento">
        <template #header>
        ...
        <div class="py-12">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="p-4 bg-white overflow-hidden shadow-xl sm:rounded-lg">
                    <form @submit.prevent="$event => form.patch(route('departamentos.update', departamentos))"
                    class="mt-6 space-y-6 max-w-xl">
                    <InputLabel for="nombre" value="Departamento"></InputLabel>
